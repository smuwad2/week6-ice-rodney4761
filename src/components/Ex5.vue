...
export default {
    ...
    methods: {
        // Add code here
        cycleTheme(){
            const maxIndex = this.themes.length - 1;
            if (this.currentThemeIndex != maxIndex){
...
<template>
    ...
    <div class="container">
        ...
        <div class="preview-section">
            <h2>Live Preview</h2>
            <div class="preview-card" :style="{'background-color':bgColor, 'color':textColor}"> <!-- Add code here to set background color and text color -->
